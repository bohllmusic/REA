    ...
    <container>
        ...
        <span class= "shdw">
            <form action="" method="post">
                <input type="text" name="lien" placeholder="déposez un lien youtube">
                <input type="text" name="texte" placeholder="écrivez quelque-chose...">
                <input type="text" name="genre" placeholder="définissez un genre">
            </form>
        </span>
